...
class EdamamGetProductsByNameHandlerTest extends AbstractIntegrationTest {

    @Autowired
    private EdamamGetProductsByNameHandler handler;
    ...
    void shouldSetProductFieldsToNullWhenDataIsMissing() {
        ...
        var product = handler.getProductsByName("Italian diced tomatoes", 1).get(0);
